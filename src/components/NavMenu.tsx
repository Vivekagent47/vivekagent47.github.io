            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  {
                    name: "LinkedIn",
                    link: "https://www.linkedin.com/in/itsvivekchauhan/",
                  },
                  {
                    name: "Instagram",
                    link: "https://www.instagram.com/vivek.agent47/",
                  },
                  { name: "Github", link: "https://github.com/vivekagent47" },
                ].map((item, index) => (
                  <motion.li
                    key={item.name}
                    initial={{ x: 20, opacity: 0 }}
